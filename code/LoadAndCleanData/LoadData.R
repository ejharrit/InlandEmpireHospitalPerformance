...
distribution_ids <- c(
  ...
  ### Medicare Hospital Spending by Claim ### ComprehensiveCareJointReplacement   ### (HVBP) - Total Performance Score                                    
  "39b7b4e2-f810-5b73-9786-75535bae10c9", "e5e3acf9-6504-5448-9e39-eb988c0b1753", "ffba8cce-1122-59fa-93d4-2e9a475bb124",
  ### (HVBP) - Efficiency Scores          ### (HVBP) - Clinical Outcomes Domain                                    
  "ecfcc479-61d9-5efe-908c-0b82e6f108e9", "f4c09337-10d1-5361-aeb4-876561254c4c"
)

data_links <- map_chr(distribution_ids, 
                      function(x) paste0("https://data.cms.gov/provider-data/api/1/datastore/sql?query=%5BSELECT%20%2A%20FROM%20",
                                             x,
...
dataset_names <- c(
  ...
  "medicare_hospital_spending_by_claim",  "comprehensive_care_joint_replacement", "hvbp_total_performance_score",
