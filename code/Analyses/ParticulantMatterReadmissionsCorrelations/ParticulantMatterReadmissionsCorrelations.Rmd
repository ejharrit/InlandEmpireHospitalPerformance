...
With our research question defined and threshold set let's take a look at the data we will be working with. The data used in this analysis was collected from two sources, the Unplanned Hospital Visits dataset provided by the Centers for Medicare and Medicaid services and annual summary data by county collected from the Environmental Protection Agency.
